...
import PersonlaInfo from './PersonlaInfo'
import EmploymentDetails from './EmploymentDetails'
import NextOfKin from './NextOfKin'
import Remittance from './Remittance'

export default function TSCProfile() {
         ...
         <div>
           ...
           <div className="line"></div>
            ...
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <a href="/accountdetails/tsc" className="breadcrumb-item-override-active">TSC Account Application</a>
              </li>
            </ol>
          </nav>
      <div className="line"></div>
       ...
       {progressValue === 0 ? 
        <PersonlaInfo moveToNext={handleProceedto} moveBack={handleProceedBack}/>
            : null 
       }

      {progressValue === 1 ? 
      <EmploymentDetails moveToNext={handleProceedto} moveBack={handleProceedBack} />            
      : null
      } 

      {progressValue === 2 ? 
        <NextOfKin moveToNext={handleProceedto} moveBack={handleProceedBack}/>  
      : null
      }     
