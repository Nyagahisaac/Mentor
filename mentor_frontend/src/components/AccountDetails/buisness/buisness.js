...
import AccountOreationIcon from '../../../images/icons/accountOp.svg'
...
export default function BuisnessProfile() {
 ...
 const [BuisnessDetailsActive, setBuisnessDetailsActive] = useState(false)
 const [AccountOperationActive, setAccountOperationActive] = useState(false)
 ...
 const handleProceedto  = (val) => {
    ...
    setActiveButtons(activeButtons + 1)
     if(val === 1){
     setBuisnessDetailsActive(true)     
    }

     if(val === 2){
        setAccountOperationActive(true)        
    }
 ...
 const handleProceedBack = (val) => {
     ...
     if(val === 1) {
        setAccountOperationActive(false)
    }
    if(val === 0) {
        setBuisnessDetailsActive(false)
    }
 }
    ...
    return (  
        ...
        <div>
           ...
           <div className="line"></div>
            ...
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item">
                <a href="/accountdetails/tsc" className="breadcrumb-item-override-active">Buisness Account Application</a>
              </li>
            </ol>
          </nav>
      <div className="line"></div>
        ...
        {AccountOperationActive ? 
            <div className="step-item">
                <div className='step-button-active text-center'>
                    <img src={AccountOreationIcon} alt="" />
                </div>
                <div className="step-title">
                    Account Operation
                </div>
      ...
      {progressValue === 1 ? 
      <BuisnessDetails moveToNext={handleProceedto} moveBack={handleProceedBack}/>            
      : null} 
