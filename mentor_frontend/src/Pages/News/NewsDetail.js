...
import NewsImage7 from '../../images/newsImages/newsimage7.png'
import NewsImage9 from '../../images/newsImages/newsimage9.jpg'
import NewsImage10 from '../../images/newsImages/newsimage10.jpg'
...
const press_releases = [
    {
        ...
        'date':'July 25, 2021',
        'url': 'https://www.mentorsacco.co.ke/news/chairman-report-2018'
    },
    {
        'id':'2',
...
function NewsDetail() {
    ...
    return (
      ...
      <div className="container mt-2r">
          ...
          <div class="row">
    <div class="col-10">
    <img src={NewsImage7} className="img-fluid" alt="" style={{width: '95%'}}/>
...
<img src={NewsImage10} alt="" className="img-fluid" style={{width: '100%', height: '60vh'}}/>
...
<h3 id="subheader">More form press releases</h3>
<div class="row mb-3">
    <div class="col">
