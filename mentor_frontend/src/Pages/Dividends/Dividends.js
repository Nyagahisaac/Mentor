    ...
    return (
        <div className="container-fluid">
            <div className="container">
                <h1 className="text-center">My Dividends </h1>
                <small>(If not logged in, redirects to login/reg page)</small>
                <h3>Name: Humphrey Ngeruro Nganga</h3>
                <p><strong>PNO: </strong> 82</p>
                <div className="row">
                    <div className="col-12 col-md-8 col-10 pc-screen-hidden">
                        <table class="table">
