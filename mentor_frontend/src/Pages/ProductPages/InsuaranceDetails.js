...
import { InsuanranceContent } from '../../LoadInfo/Insuaranceinfo'
...
export default function InsuaranceDetails(props) {
   
    const [tabActive, setTabActive] = useState(1)
    const {insuaranceType} = props.location.state
    const details = InsuanranceContent[insuaranceType]
    ...
    return (
        ...
        <nav className="container breadcrumb-div mt-1r" aria-label="breadcrumb">
            ...
            <img src={homeIcon} alt="" style={{marginRight: 5, width: '20px', height: '20px'}}/>
                ...
                <li className="breadcrumb-item">
                <a href="/insure" className="breadcrumb-item-override">Insure</a></li>
        ...
        <div className="line"></div>
           ...
           <img src={Image} alt="" style={{height: 'auto', width: '100vw'}} />
            ...
            <div className="row py-3">
                    ...
                    {details.product_info.length ?
                        <h2 id="subheader">What is covered</h2>
                        : null
                    }
                       
                        
                        <ul>
                        {details.product_info.map(det => {
                            return(<li>{det}</li>)
                        })}
                        </ul>
