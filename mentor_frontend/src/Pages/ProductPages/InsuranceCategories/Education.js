...
function Education() {
    ...
    return (
        <div>
            <h1 className="text-center">Select an education insurance product that suits your needs</h1>
                        ...
                        <div className="col-12 col-md-8">
                            <div class="row justify-content-start py-2">
                                <div className="col-9 col-md-4 mx-3 orange-lite-button black-link">
                                    <Link to="/submit/success">
                                        <div className="row py-3">
                                            <div className="col-10">Education insurance 1</div>
                                            <div className="col-1">
                                ...
                                <div className="col-9 col-md-4 mx-3 blue-lite-button black-link">
                                    <Link to="/submit/success">
                                        <div className="row py-3">
                                            <div className="col-10">Education insurance 2</div>
                                            <div className="col-1">
                                                <img height="15rem" src={ArrowImage} />
                                            </div>
                                            <div className="col-1"></div>
                                ...
                                <div className="col-9 col-md-4 mx-3 white-dark-button black-link">
                                    <Link to="/submit/success">
                                        <div className="row py-3">
                                            <div className="col-10">Education insurance 3</div>
                                            <div className="col-1">
                                                <img height="15rem" src={ArrowImage} />
                                            </div>
                                            <div className="col-1"></div>
                                ...
                                <div className="col-9 col-md-4 mx-3 white-dark-button black-link">
                                    <Link to="/submit/success">
                                        <div className="row py-3">
                                            <div className="col-10">Edcuation insurance 4</div>
                                            <div className="col-1">
                                                <img height="15rem" src={ArrowImage} />
                                            </div>
                                            <div className="col-1"></div>
