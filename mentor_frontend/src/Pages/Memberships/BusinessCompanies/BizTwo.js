...
function BizTwo() {
    ...
    return (
        <form className="row justify-content-center py-3">
            <BizRegistrationSteps step1 step2 step3 />
                    ...
                    <div className="col-12 col-md-11">
                        <div className="row align-items-center">
                            ...
                            <div class="col-12 col-md-9">
                                <select id="inputState" onChange={e=>{setKinRelationship(e.target.value)}}  style={{color:'#263238', fontWeight:'bold'}} class="form-select">
                                    <option>Select Remittance mode</option>
                        ...
                        <div className="col-12 col-md-11">
                            <div className="row align-items-center justify-content-center">
                                ...
                                <p>Please pay KES 5000 Registration fee only OR KES XXX registration fee, Minimum Monthly Deposit and Share Capital contribution to
                                Paybill No: XXXXX
                                Account No: REG
