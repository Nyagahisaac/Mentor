        ...
        <div className="container">
            <div className="row justify-content-center py-4">
                <div className="col-10 col-md-9">
                    <h2>FOSA SECTION</h2>
                    <h2>Salary Advance Request Form</h2>
                    ...
                    <Form onSubmit={submitHandler}>
                        <strong><p>Personal Information</p></strong>
                            ...
                            <Form.Group controlId = 'memberno' className="pb-1">
                                <Form.Label className="px-3">Workplace*</Form.Label>
                                <Form.Control 
                                    type = 'text' 
                            ...
                            <Form.Group controlId = 'physicaladdress' className="pb-1">
                                <Form.Label className="px-3">Advance Amount*</Form.Label>
                                <Form.Control 
                                    type = 'text' 
                            ...
                            <Form.Group controlId = 'repaymentperiod' className="pb-1">
                                <Form.Label className="px-3">Payment period*</Form.Label>
                            ...
                            <Form.Group controlId = 'employer' className="pb-1">
                                <Form.Label className="px-3">Monthly Installments*</Form.Label>
                                <Form.Control 
                                    type = 'text' 
                                    placeholder = 'Enter monthly installments amount'  
                                    value = {Employer} 
