    ...
    return (
      ...
      <div className="line"></div>
        ...
        <nav className="container breadcrumb-div mt-1r" aria-label="breadcrumb">
         ...
         <span className="breadcrumb-item-override-active">Development Loans</span>
         </li>
        </ol> 
        </nav>
        <div className="line"></div>
        <div className="container">
            <div className="row py-3 mt-2r">
                <div className="col-md-10">
                    <h2 id='subheader'>Development Loans</h2>
                    {/* <h3>Who is this for?</h3> */}
                    <strong>Select a loan that suits you</strong>
                    <p className="py-3">These loans are to be repaid within a minimum period of 48 months and upto 84 months</p>
                    <div class="row py-2">
                        ...
                        <Link to={{
                                ...
                                state: {
                                    ...
                                    loanCategory: "Development Loans",
                                    loanLink: "/solutions/development_loans_services"
                                }
                            }}
                                >
                        ...
                        <div className="col-10 col-md-5 mx-3 orange-lite-button black-link">
                            <Link to="/salary_advance/application">
                                <div className="row py-3">
...
export default DevelopmentLoans
